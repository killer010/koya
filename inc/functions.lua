--[[
KOYA ✾ @KI_LLE_R @A_j_o_k_e_r▀
✾ تم تطوير وبرمجه السورس من قبل كيلر و الجوكر ✾
│KOYA ✾ @KI_LLE_R @A_j_o_k_e_r▀
#-------------------------------------------------------------------
]]
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(koya..":NameBot:")
...
var =  'مالك السورس'
elseif redis:sismember(koya..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(koya..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(koya..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(koya..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(koya..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(koya..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(koya..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(koya..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(koya..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(koya..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(koya..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(koya..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(koya..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(koya..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(koya..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(koya..':SUDO_BOT:')
message = '✵ ** قائمه الـمـطـوريـن : \n\n`✵ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(koya..'username:'..v)
local count = redis:scard(koya..'mtwr_count'..v)
...
local monsha = redis:smembers(koya..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n✵ قائمه المدراء :*\n\n'
local list = redis:smembers(koya..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(koya..'admins:'..msg.chat_id_)
...
local list = redis:smembers(koya..'whitelist:'..msg.chat_id_)
...
if redis:sismember(koya..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(koya..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(koya..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(koya..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(koya..'gban_users')
...
local list = redis:smembers(koya..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(koya..':Filter_Word:'..msg.chat_id_,word) then 
return  "✵ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(koya..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(koya..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(koya..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(koya..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(koya..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(koya..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(koya..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(koya..'group:ids')
message = '✵ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(koya..'group:name'..v)
if info then 
...
<link href="https://fonts.koyaapis.com/css?family=Harmattan" rel="stylesheet">
...
redis:del(
koya..'group:add'..id_group,
koya..'lock_link'..id_group, 
koya..'lock_id'..id_group,
koya..'lock_spam'..id_group, 
koya..'lock_webpage'..id_group,
koya..'lock_markdown'..id_group,
koya..'lock_flood'..id_group,
koya..'lock_bots'..id_group,
koya..'mute_forward'..id_group,
koya..'mute_contact'..id_group,
koya..'mute_location'..id_group,
koya..'mute_document'..id_group,
koya..'mute_keyboard'..id_group,
koya..'mute_game'..id_group,
koya..'mute_inline'..id_group,
koya..'lock_username'..id_group,
koya..'num_msg_koya'..id_group,
koya..'replay'..id_group
)
redis:srem(koya..'group:ids',id_group)
end
...
redis:hset(koya..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(koya..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(koya..'group:add'..msg.chat_id_) then  return '✵ **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(koya..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(koya..':addnumberusers') or 0)
...
local lock_service = redis:get(koya..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(koya..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(koya..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
koya..'group:add'..msg.chat_id_,true,
koya..'lock_link'..msg.chat_id_,true, 
koya..'lock_id'..msg.chat_id_,true,
koya..'lock_spam'..msg.chat_id_,true,
koya..'lock_webpage'..msg.chat_id_,true,
koya..'lock_markdown'..msg.chat_id_,true,
koya..'lock_flood'..msg.chat_id_,true,
...
koya..'mute_keyboard'..msg.chat_id_,true,
koya..'mute_game'..msg.chat_id_,true,
koya..'mute_inline'..msg.chat_id_,true,
koya..'lock_username'..msg.chat_id_,true,
koya..'num_msg_koya'..msg.chat_id_,5, 
koya..'replay'..msg.chat_id_,true
)

redis:sadd(koya..'group:ids',msg.chat_id_) 
redis:sadd(koya..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(koya..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(koya..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(koya..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(koya..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(koya..'username:'..UserID,'username',Resolv)
redis:sadd(koya..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(koya..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(koya..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(koya..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(koya..'username:'..UserID,'username',Resolv)
redis:sadd(koya..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(koya..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(koya..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(koya..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(koya..'username:'..UserID, 'username', Resolv)
redis:sadd(koya..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(koya..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(koya..'whitelist:'..ChatID,UserID)
...
if redis:sismember(koya..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(koya..'username:'..UserID, 'username', Resolv)
redis:sadd(koya..'owners:'..ChatID,UserID)
...
if redis:sismember(koya..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(koya..'username:'..UserID, 'username', Resolv)
redis:sadd(koya..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(koya..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(koya..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(koya..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(koya..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(koya..'msgs:'..UserID..':'..ChatID) or 1
...
return sendMsg(ChatID,MsgID,"✵ **لا يمكنك حظر مالك السورس\n") 
elseif UserID == 1282382975 then 
return sendMsg(ChatID,MsgID,"✵ لا يمكنك حظر  المبرمج كيلر\n")
...
redis:hset(koya..'username:'..UserID, 'username', Resolv)
redis:sadd(koya..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(koya..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(koya..'banned:'..ChatID,UserID)
...
return sendMsg(ChatID,MsgID,"✵ **لا يمكنك كتم مالك السورس\n") 
elseif UserID == 1282382975 then 
return sendMsg(ChatID,MsgID,"✵ لا يمكنك كتم  المبرمج كيلر\n")
elseif UserID == 1317966118 then 
...
if redis:sismember(koya..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(koya..'username:'..UserID, 'username', Resolv)
redis:sadd(koya..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(koya..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(koya..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(koya..'username:'..UserID, 'username',Resolv)
redis:sadd(koya..'gban_users',UserID)
...
redis:srem(koya..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(koya..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(koya..'username:'..UserID, 'username', Resolv)
redis:sadd(koya..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(koya..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(koya..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
return sendMsg(ChatID,MsgID,"✵ **لا يمكنك تقييد مالك السورس\n") 
elseif UserID == 1282382975 then 
return sendMsg(ChatID,MsgID,"✵ **لا يمكنك تقييد المبرمج كيلر\n") 
elseif UserID == 1317966118 then 
...
redis:hset(koya..'username:'..UserID, 'username', UserName)
redis:sadd(koya..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(koya..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'✵ **العضو » ❪ '..UserName..' ❫\n✵ **الايدي » ❪ `'..UserID..'` ❫\n✵ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"✵ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(koya..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"✵ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(koya..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"✵ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(koya..'admins:'..ChatID,UserID) then 
...
return sendMsg(ChatID,MsgID,"✵ **لا يمكنك طرد مالك السورس\n") 
elseif UserID == 1282382975 then 
return sendMsg(ChatID,MsgID,"✵ لا يمكنك طرد  المبرمج كيلر\n")
elseif UserID == 1317966118 then 
...
Restrict(ChatID,UserID,1)
redis:hset(koya..'username:'..UserID, 'username', Resolv)
redis:sadd(koya..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(koya..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(koya..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'✵ **العضو » '..USERNAME..' \n✵ ** الايدي » (`'..UserID..'`)\n✵ **انه بالتأكيد ليس مطور \n') end
redis:srem(koya..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'✵ العضو » ❪ '..USERNAME..' ❫\n✵ الايدي » ❪ '..UserID..' ❫\n✵ تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(koya..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(koya..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(koya..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(koya..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*✵*` اعدادات المجموعه :` \n"
.."\n✵ التعديل «» "..(redis:get(koya..'lock_edit'..msg.chat_id_) or 'false')
.."\n✵ الروابط «» "..(redis:get(koya..'lock_link'..msg.chat_id_) or 'false')
.."\n✵ التاك «» "..(redis:get(koya..'lock_tag'..msg.chat_id_) or 'false')
.."\n✵ المعرفات «» "..(redis:get(koya..'lock_username'..msg.chat_id_) or 'false')
.."\n✵ التكرار «» "..(redis:get(koya..'lock_flood'..msg.chat_id_) or 'false')
.."\n✵ الكلايش «» "..(redis:get(koya..'lock_spam'..msg.chat_id_) or 'false')
.."\n✵ الويب «» "..(redis:get(koya..'lock_webpage'..msg.chat_id_) or 'false')
.."\n✵ الماركدوان «» "..(redis:get(koya..'lock_markdown'..msg.chat_id_) or 'false')
.."\n✵ بالطرد البوتات «» "..(redis:get(koya..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n✵ البوتات «» "..(redis:get(koya..'lock_bots'..msg.chat_id_) or 'false')
.."\n✵ عدد التكرار «» "..(redis:get(koya..'num_msg_koya'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n✵`اعدادات الوسائط :`\n"
.."\n*✵ *المتحركه «» "..(redis:get(koya..'mute_gif'..msg.chat_id_) or 'false')
.."\n✵ الدردشه «» "..(redis:get(koya..'mute_text'..msg.chat_id_) or 'false')
.."\n✵ الانلاين «» "..(redis:get(koya..'mute_inline'..msg.chat_id_) or 'false')
.."\n✵ الالعاب «» "..(redis:get(koya..'mute_game'..msg.chat_id_) or 'false')
.."\n✵ الصور «» "..(redis:get(koya..'mute_photo'..msg.chat_id_) or 'false')
.."\n✵ الفيديو «» "..(redis:get(koya..'mute_video'..msg.chat_id_) or 'false')
.."\n✵ البصمات «» "..(redis:get(koya..'mute_audio'..msg.chat_id_) or 'false')
.."\n✵ الصوت «» "..(redis:get(koya..'mute_voice'..msg.chat_id_) or 'false')
.."\n✵ الملصقات «» "..(redis:get(koya..'mute_sticker'..msg.chat_id_) or 'false')
.."\n✵ الجهات «» "..(redis:get(koya..'mute_contact'..msg.chat_id_) or 'false')
.."\n✵ التوجيه «» "..(redis:get(koya..'mute_forward'..msg.chat_id_) or 'false')
.."\n✵ الموقع «» "..(redis:get(koya..'mute_location'..msg.chat_id_) or 'false')
.."\n✵ الملفات «» "..(redis:get(koya..'mute_document'..msg.chat_id_) or 'false')
.."\n✵ الاشعارات «» "..(redis:get(koya..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n✵ الكيبورد «» "..(redis:get(koya..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*✵*`اعدادات اخرى : `"
.."\n\n*✵*الترحيب «» "..welcomex
.."\n*✵*الردود «» "..replayx
...
.."\n*✵*الويب «» "..(redis:get(koya..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*✵*الماركدوان «» "..(redis:get(koya..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*✵*البوتات بالطرد «» "..(redis:get(koya..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*✵*البوتات «» "..(redis:get(koya..'lock_bots'..msg.chat_id_) or 'false')
.."\n*✵*عدد التكرار «» "..(redis:get(koya..'num_msg_koya'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*✵*اعدادات التقـييد :\n"
.."\n*✵*التقييد بالتوجيه «» "..(redis:get(koya..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*✵*التقييد بالصور «» "..(redis:get(koya..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*✵*التقييد بالروابط «» "..(redis:get(koya..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*✵*التقييد بالمتحركه «» "..(redis:get(koya..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*✵*التقييد الفيديو «» "..(redis:get(koya..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
